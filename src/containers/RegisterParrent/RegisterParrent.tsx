...
const RegisterParrent: React.FunctionComponent = (): React.ReactElement => {
            ...
            >
                {({ isValid, errors, touched, handleSubmit, handleChange, handleBlur }) => (
                    <Form className={styles.LoginForm}>
                        ...
                        <Field readOnly={true} className={styles.LoginInput} name="doctorId" type="text" placeholder="ID Врача" />
...
export default RegisterParrent;